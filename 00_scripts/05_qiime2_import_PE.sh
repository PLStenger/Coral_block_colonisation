...
OUTPUT=/scratch_vol1/fungi/BioIndic_La_Reunion_Island_Lagoon/05_QIIME2/Original_reads_TUFA
...
MANIFEST=/scratch_vol1/fungi/BioIndic_La_Reunion_Island_Lagoon/98_database_files/manifest_TUFA
TMPDIR=/scratch_vol1
