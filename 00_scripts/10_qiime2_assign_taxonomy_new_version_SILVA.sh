...
WORKING_DIRECTORY=/scratch_vol0/fungi/Coral_block_colonisation/05_QIIME2
OUTPUT=/scratch_vol0/fungi/Coral_block_colonisation/05_QIIME2/visual

DATABASE=/scratch_vol0/fungi/Coral_block_colonisation/98_database_files
TMPDIR=/scratch_vol0
