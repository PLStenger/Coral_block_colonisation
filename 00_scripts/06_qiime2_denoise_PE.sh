...
## OUTPUT=/scratch_vol1/fungi/Coral_block_colonisation/05_QIIME2/visual/Original_reads_TUFA
## 
## # Make the directory (mkdir) only if not existe already(-p)
## mkdir -p $OUTPUT
## 
## METADATA=/scratch_vol1/fungi/Coral_block_colonisation/98_database_files/sample-metadata.tsv
...
WORKING_DIRECTORY=/scratch_vol1/fungi/Coral_block_colonisation/05_QIIME2/Original_reads_16S_ITS_18S_negative_control
OUTPUT=/scratch_vol1/fungi/Coral_block_colonisation/05_QIIME2/visual/Original_reads_16S_ITS_18S_negative_control
...
OUTPUT=/scratch_vol1/fungi/Coral_block_colonisation/05_QIIME2/visual/Original_reads_16S_ITS_18S_NC

# Make the directory (mkdir) only if not existe already(-p)
mkdir -p $OUTPUT

METADATA=/scratch_vol1/fungi/Coral_block_colonisation/98_database_files/sample-metadata_others_markers_NC.tsv
# negative control sample :
#NEG_CONTROL=/scratch_vol1/fungi/Coral_block_colonisation/98_database_files/Negative_control_Sample_RepSeq_V4.qza
...
OUTPUT=/scratch_vol1/fungi/Coral_block_colonisation/05_QIIME2/visual/Original_reads_16S_ITS_18S_Reu
